(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("vuetify/lib/components/VApp"), require("vuetify/lib/components/VAppBar"), require("vuetify/lib/components/VBtn"), require("vuetify/lib/components/VDivider"), require("vuetify/lib/components/VGrid"), require("vuetify/lib/components/VIcon"), require("vuetify/lib/components/VMain"), require("vuetify/lib/components/VNavigationDrawer"), require("vuetify/lib/components/VSheet"));
	else if(typeof define === 'function' && define.amd)
		define(["vuetify/lib/components/VApp", "vuetify/lib/components/VAppBar", "vuetify/lib/components/VBtn", "vuetify/lib/components/VDivider", "vuetify/lib/components/VGrid", "vuetify/lib/components/VIcon", "vuetify/lib/components/VMain", "vuetify/lib/components/VNavigationDrawer", "vuetify/lib/components/VSheet"], factory);
	else if(typeof exports === 'object')
		exports["Vxg"] = factory(require("vuetify/lib/components/VApp"), require("vuetify/lib/components/VAppBar"), require("vuetify/lib/components/VBtn"), require("vuetify/lib/components/VDivider"), require("vuetify/lib/components/VGrid"), require("vuetify/lib/components/VIcon"), require("vuetify/lib/components/VMain"), require("vuetify/lib/components/VNavigationDrawer"), require("vuetify/lib/components/VSheet"));
	else
		root["Vxg"] = factory(root["vuetify/lib/components/VApp"], root["vuetify/lib/components/VAppBar"], root["vuetify/lib/components/VBtn"], root["vuetify/lib/components/VDivider"], root["vuetify/lib/components/VGrid"], root["vuetify/lib/components/VIcon"], root["vuetify/lib/components/VMain"], root["vuetify/lib/components/VNavigationDrawer"], root["vuetify/lib/components/VSheet"]);
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE_vuetify_lib_components_VApp__, __WEBPACK_EXTERNAL_MODULE_vuetify_lib_components_VAppBar__, __WEBPACK_EXTERNAL_MODULE_vuetify_lib_components_VBtn__, __WEBPACK_EXTERNAL_MODULE_vuetify_lib_components_VDivider__, __WEBPACK_EXTERNAL_MODULE_vuetify_lib_components_VGrid__, __WEBPACK_EXTERNAL_MODULE_vuetify_lib_components_VIcon__, __WEBPACK_EXTERNAL_MODULE_vuetify_lib_components_VMain__, __WEBPACK_EXTERNAL_MODULE_vuetify_lib_components_VNavigationDrawer__, __WEBPACK_EXTERNAL_MODULE_vuetify_lib_components_VSheet__) {
